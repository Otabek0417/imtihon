...
selectCategory.forEach((category) => {
  category.addEventListener("click", () => {
    ...
    //   selectApi = "https://countries-api-v7sn.onrender.com/countries?limit=250";
    // } else {
    //   selectApi = `https://countries-api-v7sn.onrender.com/countries?region=${category.textContent}`;
    // }
    // getData(selectApi)
    //   .then((data) => {
    //     UpdateUI(data.data);
